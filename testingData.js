...
const breads = [
  ...
  bread3 = {
    id: 3,
    name: 'Regular Bread',
    description: 'Full of wheat. Giving this a long description so it tries to overflow the box I put it in. No bread, bad bread, stay in your box',
    price: 500,
  ...
  bread4 = {
    ...
    description: 'Good good bread from my special basement bakery',
    price: 1200,
    photo_url: 'https://i.imgur.com/VoD6osL.jpg',
    creation_date: '2020-02-06',
    user_id: 3,
    featured: false,
    weight: '400g',
  ...
  bread5 = {
    id: 5,
    name: 'Cinnamon Cinnamon',
    description: 'A welcome respite',
    price: 800,
    photo_url: 'https://i.imgur.com/nhoaRcZ.jpg',
    creation_date: '2020-02-06',
    user_id: 3,
    featured: false,
    weight: '400g',
