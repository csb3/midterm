const alertMessages = {
  ...
  '200A': '<i class="fas fa-check-circle"></i> SUCCESS: Listing deleted!',
  '200B': '<i class="fas fa-check-circle"></i> SUCCESS: Listing marked as sold. Lucky buyer!',

  '201A': '<i class="fas fa-check-circle"></i> New listing created!',
  ...
  // USERS ROUTE
  '200C': '<i class="fas fa-check-circle"></i> Welcome back!',
